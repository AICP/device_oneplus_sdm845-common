...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/prebuilts/etc/permissions/android.hardware.camera.full.xml:system/etc/permissions/android.hardware.camera.full.xml \
    $(LOCAL_PATH)/prebuilts/etc/permissions/android.hardware.camera.raw.xml:system/etc/permissions/android.hardware.camera.raw.xml \
    ...
    $(LOCAL_PATH)/prebuilts/etc/permissions/privapp-permissions-hotword.xml:system/etc/permissions/privapp-permissions-hotword.xml \
